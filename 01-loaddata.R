...
kickoffs <- 
  data %>% 
  filter(play_type == "kickoff" | (yardline_100 < 85 & yardline_100 > 70)) %>% 
  select(game_id, defteam, away_team, score_differential, qtr, quarter_seconds_remaining, yardline_100, play_type)
